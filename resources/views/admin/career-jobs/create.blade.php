{{-- resources/views/career-jobs/create.blade.php --}}
@extends('layouts.admin')

@section('title', 'Create Career Job')
@section('header', 'Create New Career Job')
@section('breadcrumbs')
        ...
        <div class="col-md-12">
            <div class="card form-card">
                <div class="card-header">
                    <h3><i class="bi bi-plus-circle"></i> Career Job Information</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('career-jobs.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="help-text">e.g., Engineering, Marketing, Sales</div>
                                @error('department')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="help-text">City, State or Remote</div>
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="experience" class="form-control @error('experience') is-invalid @enderror" 
                                       value="{{ old('experience') }}" min="0" max="50" required>
                                <div class="help-text">Minimum years of experience required</div>
                                @error('experience')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="created_date" class="form-control @error('created_date') is-invalid @enderror" 
                                       value="{{ old('created_date', date('Y-m-d')) }}" required>
                                @error('created_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="help-text">Brief summary of the job (max 500 characters)</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="help-text">Detailed job description, responsibilities, and requirements</div>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-submit">
                                <i class="bi bi-save"></i> Create Career Job
                            </button>
