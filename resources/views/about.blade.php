                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-6 order-lg-1 order-2">
                        <div class="about-pg__story-img-wrap">
                            <img src="{{ $ourStory->image }}" alt="{{ $ourStoryTitle->title }}" loading="lazy">
                    ...
                    <div class="col-lg-6 order-lg-2 order-1">
                        ...
                        <a href="{{ $ourStory->button_url ?? route('home.portfolio') }}"
                            class="btn-outline-custom btn-secondary-custom mt-2">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="about-pg__team-card">
                            <div class="about-pg__team-img-wrap">
                                <img src="{{ asset($member->image) }}" alt="{{ $member->name }}" loading="lazy">
                            </div>
